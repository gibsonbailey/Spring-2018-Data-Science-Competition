...
BATCH_SIZE = 100
DATA_PORTION = 1000
TRAIN_PORTION = 4 * DATA_PORTION // 5
...
with tf.Session() as sess:
    ...
    for epoch in range(EPOCHS):
        print("Total number of batches to be run:", total_batch_num)
        print("\n")
        avg_cost = 0
        batch_low_ind = 0
    ...
    if SUBMIT:
        ...
        # check_tick = time.clock()
        # check_toc = time.clock()
        # print("Appending time:",check_toc - check_tick)
        # row = []
        # i += 1
